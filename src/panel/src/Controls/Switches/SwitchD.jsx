          ...
          {state === 0 ? (
            ...
            >
              ...
              <rect
                ...
                strokeWidth="2"
              />
              <circle cx="9" cy="43" r="4" fill="#545454" />
              <circle cx="41" cy="43" r="4" fill="#545454" />
              <circle cx="25" cy="43" r="4" fill="#545454" />
            </svg>
          ) : (
            <svg
              width={size}
            ...
            >
              ...
              <rect
                ...
                strokeWidth="2"
              />
              <circle cx="9" cy="7" r="4" fill="#545454" />
              <circle cx="41" cy="7" r="4" fill="#545454" />
              <circle cx="25" cy="7" r="4" fill="#545454" />
            </svg>
          )}
        </div>
        <span
